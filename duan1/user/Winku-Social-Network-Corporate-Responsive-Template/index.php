...
<body>
  ...
  switch ($action) {
    ...
    case "login":
      ...
      break;
    case "new":
      include '../Winku-Social-Network-Corporate-Responsive-Template/view/newsfeed.php';
      break;
    case "fen":
      include '../Winku-Social-Network-Corporate-Responsive-Template/view/timeline-friends.php';
      break;
    case "fav":
